...
func GenerateDiagnosticsReport(includeEndpoints bool, includeLogs bool, logLines int) (string, error) {
	...
	fmt.Fprintln(output, "Photon Daemon - Diagnostics Report")
	printHeader(output, "Versions")
	fmt.Fprintln(output, "          Photon Daemon:", system.Version)
	if dockerErr == nil {
	...
	printHeader(output, "Daemon Configuration")
	...
	printHeader(output, "Latest Daemon Logs")
	if includeLogs {
		p := path.Join(cfg.System.LogDirectory, "photon-daemon.log")
