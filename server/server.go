...
import (
	...
	"github.com/Photon-Panel/Photon-Daemon/events"
	"github.com/Photon-Panel/Photon-Daemon/remote"
	"github.com/Photon-Panel/Photon-Daemon/server/filesystem"
...
type Server struct {
	...
	// fetched from the Photon Panel instance each time the server process is
...
// Sync syncs the state of the server on the Panel with the daemon. This ensures that
...
// instance on the daemon. This includes the information needed by the Panel in order
