...
//
// This handles daemon exiting during either of these processes which will leave
// things in a bad state within the Panel. This API call is executed once the daemon
