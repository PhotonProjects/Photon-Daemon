...
import (
	...
	"github.com/Photon-Panel/Photon-Daemon/parser"
)
...
// the Panel. When a server process is started, the daemon communicates with the
...
// when determining if the credentials provided to the daemon are valid.
...
// instance. This sets what the daemon is looking for to mark a server as done
