...
const (
	DefaultHastebinUrl = "https://logs.photonpanel.dev"
	DefaultLogLines    = 200
)
...
func newDiagnosticsCommand() *cobra.Command {
	command := &cobra.Command{
		Use:   "diagnostics",
		Short: "Collect and report information about this Photon Daemon instance to assist in debugging.",
...
// diagnosticsCmdRun collects diagnostics about the daemon, its configuration and the node.
// We collect:
// - the daemon and docker versions
