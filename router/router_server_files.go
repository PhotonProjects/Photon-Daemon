...
import (
	...
	"github.com/Photon-Panel/Photon-Daemon/internal/models"
	"github.com/Photon-Panel/Photon-Daemon/internal/ufs"
	"github.com/Photon-Panel/Photon-Daemon/router/downloader"
...
func postServerDecompressFiles(c *gin.Context) {
	...
	if err != nil {
		if filesystem.IsErrorCode(err, filesystem.ErrCodeUnknownArchive) {
			...
			c.AbortWithStatusJSON(http.StatusBadRequest, gin.H{"error": "The archive provided is in a format the daemon does not understand."})
			return
		}
		middleware.CaptureAndAbort(c, err)
		return
