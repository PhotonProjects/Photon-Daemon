...
import (
	...
	"github.com/Photon-Panel/Photon-Daemon/internal/diagnostics"
	"github.com/Photon-Panel/Photon-Daemon/router/middleware"
	"github.com/Photon-Panel/Photon-Daemon/router/tokens"
	"github.com/Photon-Panel/Photon-Daemon/server"
	"github.com/Photon-Panel/Photon-Daemon/server/installer"
...
// Returns resource utilization info for the system the daemon is running on.
...
// Creates a new server on the photon daemon and begins the installation process
// for it.
...
// Updates the running configuration for this Photon Daemon instance.
